                        ...
                        if (notLearnedList.isEmpty()) println("Все слова в словаре выучены!")
                            ...
                            try {
                                ...
                                if (choiceOfUser !in 0..ANSWER_OPTIONS) {
                                    ...
                                    when (choiceOfUser) {
                                        0 -> break
                                        1 -> if (questionWords.indexOf(originalWord) == questionWords.indexOf(
                                                questionWords[0]
                                            )
                                        ) {
                                            println("Верно!")
                                        ...
                                        2 -> if (questionWords.indexOf(originalWord) == questionWords.indexOf(
                                                questionWords[1]
                                            )
                                        ) {
                                            println("Верно!")
                                        ...
                                        3 -> if (questionWords.indexOf(originalWord) == questionWords.indexOf(
                                                questionWords[2]
                                            )
                                        ) {
                                            println("Верно!")
                                        ...
                                        4 -> if (questionWords.indexOf(originalWord) == questionWords.indexOf(
                                                questionWords[3]
                                            )
                                        ) {
                                            println("Верно!")
